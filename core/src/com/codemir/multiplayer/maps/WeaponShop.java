...
public class WeaponShop implements Screen {
    ...
    public WeaponShop(Multiplayer game) {
        this.game = game;
        ...
        tiledMap = new TmxMapLoader().load("maps/weaponshop.tmx");
            ...
            socket.on("createPlayer", new Emitter.Listener() {
                ...
                public void call(Object... args) {
                    ...
                    try {
                        ...
                        Gdx.app.log("SocketIO", "New player connected to weaponshop: " + playerId);
